(function($) {
    ...
    Drupal.behaviors.atedxglobal = {
        attach: function(context, settings) {
            var $body = $('body');

            // School Page filter adjuster
            if ( $body.hasClass('node-type-school') || $body.hasClass('page-school') ) {

                if ( $('.block-courses-school .view-header').length ) {
                    $('.block-courses-filter')
                        .appendTo('.block-courses-school .view-header')
                        .removeClass('block-courses-filter-school')
                        .addClass('block-courses-filter-inline');
                } else {
                    $('.block-courses-filter').remove();
                }
            }
        }
    };
    ...
    // Segment io - Code provided externally
    ...
    var edx_cookie = document.cookie;
    if((edx_cookie.indexOf("utmcsr=edx.org") > -1)||(edx_cookie.indexOf("utmcsr=courses.edx.org") > -1)){
          document.cookie =  '__utma=; domain=edx.org';
          document.cookie =  '__utmb=; domain=edx.org';
          document.cookie =  '__utmc=; domain=edx.org';
          document.cookie =  '__utmz=; domain=edx.org';
          document.cookie =  '__utmv=; domain=edx.org';
    }
...
/**
 *  classList polyfill
 *  User for ftEllipsis o work in IE9
